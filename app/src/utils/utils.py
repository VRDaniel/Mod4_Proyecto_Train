...
class IBMCOS:
    ...
    def save_object_in_cos(self, obj, name, timestamp, bucket_name='cos-bucket-mod4'):
        """
    ...
    def get_object_in_cos(self, key, bucket_name='cos-bucket-mod4'):
        """
    ...
    def get_csv_in_cos(self, key, bucket_name='cos-bucket-mod4'):
        """
            Función para obtener un csv de IBM COS.

            Args:
               key (str):  Nombre del csv a obtener de COS.
        ...
        obj = self.connection.Object(bucket_name=bucket_name, key=key).get()
        return obj
